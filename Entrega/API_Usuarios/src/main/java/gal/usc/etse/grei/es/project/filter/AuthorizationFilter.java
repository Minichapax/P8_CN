    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
        try{
            ...
            try {
                ...
                // Se o token era válido, establecemolo no contexto de seguridade de Spring para poder empregalo nos nosos servizos
                SecurityContextHolder.getContext().setAuthentication(authentication);
            } catch( Exception e ){
                // Si el token no era válido, tanto en formato, revocación o caducidad, devolvemos 401, según RFC 6750 seccion 3.1
            ...
            // NOTA: Cambiamos o cógigo ao 401 según RFC 6750 seccion 3.1
            response.setStatus(401);
        }
    }
